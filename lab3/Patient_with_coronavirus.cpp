...
Patient_with_coronavirus::Patient_with_coronavirus(const string& pname, int page, const string& ptravel_history, const string& coronavirus_name, const string& coronavirus_genus) : Patient(pname, page), travel_history(ptravel_history), coronavirus(coronavirus_name, coronavirus_genus) {}


//TODO: complete Patient_with_coronavirus::print_travel_history
void Patient_with_coronavirus::print_travel_history() const {
    cout << get_name() << " has traveled to : " << travel_history <<'\n';
...
void Patient_with_coronavirus::print_virus_info() const {
    ...
    cout << get_name() << " is infected with " << coronavirus.get_name() << ", which belongs to " << coronavirus.get_genus() << " genus.\n";
}